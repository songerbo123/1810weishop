...
@section('content')
     ...
     <div id="sliderA" class="slider">
         @foreach($priceInfo as $k=>$v)
            <a href="/proinfo/{{$v->goods_id}}"><img src="http://uploads.weishop.com/{{$v->goods_img}}"/></a>
         @endforeach
     </div><!--sliderA/-->
     <ul class="pronav">
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="/proinfo/{{$v->goods_id}}"><img src="http://uploads.weishop.com/{{$v->goods_img}}"/></a></dt>
